...
public class ServidorController {
    ...
    @PostMapping()
    public void mediaConsumoSemanaAnterior(@RequestBody String dadoEncriptado) throws Exception {
        //sensoriamento.desencriptar(dadoEncriptado);
        sensoriamento.mediaConsumoSemanaAnterior(sensoriamento.desencriptar(dadoEncriptado));
    }
